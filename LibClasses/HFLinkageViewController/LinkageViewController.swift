...
@objc public protocol LinkageChildViewControllerProtocol: NSObjectProtocol {
...
open class LinkageViewController: UIViewController {
   ...
   var pageHeaderView : UIView?  // 头部视图
    ...
    // 设置空，表示去掉
    open func setupPageHeader(header:UIView?, heigth:CGFloat) {
    ...
    open func setupModels(models:[LinkageModelProtocol], selected index:Int) {
        _models = models
