...
open class TestCollectionViewController: UIViewController,LinkageChildViewControllerProtocol,UICollectionViewDelegate {
    weak public var linkpageDelgate: LinkageManager?
